...
export default function SideNavQuotes() {
  return (
    <div className="side-nav-quotes side-nav-container">
      <h5>Quotes to Remember</h5>
      <p className="side-nav-quotes-text">"It only takes one yes"</p>
      <p className="side-nav-quotes-text">"Every rejection is a redirection"</p>
